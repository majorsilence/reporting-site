...
description: "How to bind report datasets to embedded charts that render inline alongside tables and text in Majorsilence Reporting."
comments: true
enable_syntax_highlighting: true
---

Majorsilence Reporting supports embedded charts that render inline on the report page alongside tables and text. Charts are bound to report datasets, so the same dataset can drive both a summary chart and a detail table on the same page.
...
The chart definition lives entirely in the RDL file, so there's nothing extra to configure on the C# side.
